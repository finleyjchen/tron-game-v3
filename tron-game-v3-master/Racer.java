...
public class Racer extends Observable {
    ...
    private Path path;
    private Color color, trailColor;
    ...
    public Racer(int x, int y, String direction, Color c)
    {
        this.x = x;
        this.y = y;
        speed = 1;
    ...
    public Racer(int x, int y, String direction, Color c, int speed)
    {
        this.x = x;
        this.y = y;
        this.speed = speed;
